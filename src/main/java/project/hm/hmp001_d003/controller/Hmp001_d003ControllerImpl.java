...
public class Hmp001_d003ControllerImpl implements Hmp001_d003Controller {
	...
	public ModelAndView searchMod(@RequestParam(value="p_mod_id", required=false) String p_prod_id, HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	@RequestMapping(value = "/common/ajaxTest2", produces="application/json", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public Map<String, Object> ajaxTest2() {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("prod_id", "hong");
		map.put("vend_id", "홍길동");
		return map;
	}
}
